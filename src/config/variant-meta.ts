...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'GeoSpy - Real-Time Global Intelligence Dashboard',
    description: 'GeoSpy real-time global intelligence dashboard. Conflicts, markets, military, climate, and OSINT in one live map. AGPL fork of WorldMonitor.',
    keywords: 'GeoSpy, AI intelligence, AI-powered dashboard, global intelligence, geopolitical dashboard, world news, market data, military bases, nuclear facilities, undersea cables, conflict zones, real-time monitoring, situation awareness, OSINT, flight tracking, AIS ships, earthquake monitor, protest tracker, power outages, oil prices, government spending, polymarket predictions',
