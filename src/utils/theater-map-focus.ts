...
const THEATER_CENTROIDS: Record<string, { lat: number; lon: number }> = {
  ...
  'latin america & caribbean': { lat: -10.0, lon: -60.0 },
  'sub-saharan africa': { lat: 0.0, lon: 20.0 },
  'europe & central asia': { lat: 48.0, lon: 40.0 },
  'east asia & pacific': { lat: 20.0, lon: 120.0 },
  'middle east & n. africa': { lat: 28.0, lon: 35.0 },
  'middle east & north africa': { lat: 28.0, lon: 35.0 },
  'mena': { lat: 28.0, lon: 35.0 },
